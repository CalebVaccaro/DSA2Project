...
void Application::InitVariables(void)
{
	...
	{
	default:
		totemMesh->GenerateCube(2.0f, C_CYAN);
		break;
	case 1:
		totemMesh->GenerateCone(1.0f, 2.0f, 10, C_CYAN);
		break;
	case 2:
		totemMesh->GenerateCylinder(1.0f, 2.0f, 10, C_CYAN);
		break;
	case 3:
		totemMesh->GenerateTube(1.0f, 0.7f, 1.0f, 10, C_CYAN);
		break;
	case 4:
		totemMesh->GenerateSphere(1.0f, 5, C_CYAN);
		break;
	case 5:
		totemMesh->GenerateTorus(1.0f, 0.6f, 10, 10, C_CYAN);
		break;
	}
}
...
void Application::Display(void)
{
	...
	totemMesh->Render(m4Projection, m4View, ToMatrix4(m_qArcBall));
