...
// Created By: Caleb V
void Simplex::MyCamera::SetPosition(vector3 a_v3Position, vector3 a_v3Target) { 
...
void Simplex::MyCamera::ResetCamera(vector3* cam_Pos)
{
	m_v3Position = *cam_Pos; //Where my camera is located
...
//: Helpful Scrip that Might Be Useful
