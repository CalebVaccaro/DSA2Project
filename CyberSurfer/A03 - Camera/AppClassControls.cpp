...
double xpos;
double ypos;
// Add a Mouse Drag Callback
// Changes CameraFront
// Caleb Vaccaro
void Application::mouse_callback(sf::Event a_event)
{
	if (firstMouse)
	{
		lastX = xpos;
...
#pragma region Camera Position
	...
	// Added More Inputs for User
	// Caleb Vaccaro
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::W))
		cameraPos += fSpeed * cameraFront;
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::S))
		cameraPos -= fSpeed * cameraFront;
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::A))
		cameraPos -= glm::normalize(glm::cross(cameraFront, cameraUp)) * fSpeed;
