...
#pragma region Debugging Information
	...
	// Text to show GameState Data
	if (startedRace == false)
	{
		m_pMeshMngr->PrintLine("Started Race: false", C_RED);
	}else
	{
		m_pMeshMngr->PrintLine("Started Race: true", C_GREEN);

	}

	if (completedRace == false)
	{
		m_pMeshMngr->PrintLine("Completed Race: false", C_RED);
	}
	else
	{
